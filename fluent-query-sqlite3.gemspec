...
Gem::Specification.new do |s|
  ...
  s.homepage = %q{http://github.com/martinkozak/fluent-query-sqlite3}
  s.licenses = [%q{MIT}]
  s.require_paths = [%q{lib}]
  s.rubygems_version = %q{1.8.5}
  s.summary = %q{SQlite3 support for the Fluent Query. Fluent Query is cool way how to write SQL queries in Ruby.}
